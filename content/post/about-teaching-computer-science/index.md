...
{{< figure
  src="distracted-mathematician.jpeg"
  type="margin"
  alt="distracted mathematician meme"
>}}
...
I am writing this short post just to tell the readers that any tutorials/explanations I provide on this blog will focus on pedagogical clarity *more than* information dense text. {{< marginnote >}}While trying to provide abstractions and analogies, I might also give inaccurate details of some concepts, so please consider them as what they actually are, abstractions.{{< /marginnote >}} This means that I will focus more on providing analogies and abstractions. You are advised to read books and documentation when actually learning the topic in detail, or using it in your projects, my job is to get you curious enough to dig into the details.
