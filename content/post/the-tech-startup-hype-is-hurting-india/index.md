...
{{< figure
  src="proompts.png"
  type="margin"
  title="Delv's interface"
  caption="You can upload a PDF and simply ask questions within it's context"
  alt="Delv's interface"
>}}
{{< figure
  src="bing.png"
  type="margin"
  title="Copilot in Microsoft Edge"
...
{{< figure
  src="carrotcopy.png"
  title="Carrot2 is an open-source project"
  alt="carrot2 screenshot shown on delv's website"
>}}
...
{{< figure
  src="get-funded.png"
  type="margin"
  alt="get funded meme by momnkeyuser"
>}}
...
{{< figure
  src="cred-meme.png"
  type="margin"
  alt="a meme about cred vs. LIC offices"
>}}
